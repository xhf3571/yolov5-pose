...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/disk/xuhaifeng/edgeai-yolov5-yolo-pose/models/changes/yolov5n_kpts.yaml', help='model.yaml path')
    ...
    parser.add_argument('--name', default='yolov5n_kpts-crowdpose', help='save to project/name')
