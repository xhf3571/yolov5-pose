...
def train(hyp, opt, device, tb_writer=None):
    ...
    last = wdir / 'Yolov5s6_pose_640.pt'
    best = wdir / 'best.pt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/disk/xuhaifeng/yolov5-pose/models/hub/yolov5s6_kpts_ti_lite.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/crowdpose.yaml', help='data.yaml path')
    ...
    parser.add_argument('--name', default='yolov5s6_kpts_ti_lite-crowdpose', help='save to project/name')
    ...
    parser.add_argument("--patience", type=int, default=120, help="EarlyStopping patience (epochs without improvement)")
