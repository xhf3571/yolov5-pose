...
from models.PKINet import PKIBlock, C3_CAA
from models.upsample.dysample import DySample
...
ChangeYaml='/home/disk/xuhaifeng/edgeai-yolov5-yolo-pose/models/changes/yolov5s6-C3_CAA-dySample_kpts.yaml'
RawYaml = '/home/disk/xuhaifeng/edgeai-yolov5-yolo-pose/models/hub/yolov5s_kpts.yaml'
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--cfg', type=str, default=ChangeYaml, help='model.yaml')
